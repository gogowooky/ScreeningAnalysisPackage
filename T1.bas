...
Public Function SYSTEM(Optional param As String = "")
        ...
        Select Case param
                ...
                Case "version":        SYSTEM = "ver. 1.2.1"
                Case "update":         SYSTEM = "2017/9/24 11:15"
...
Public Function PLATEREADER_INFO(param As String) As String
        Select Case T1.PLATE("", "reader")
                ...
                Case "TRISTAR":    PLATEREADER_INFO = T1.TRISTAR_INFO(param)
...
Public Function PLATEREADER_VALUE(wellpos As String, id As String, Optional param1 As Variant = Null, Optional param2 As Variant = Null, Optional param3 As Variant = Null) As Variant
        Select Case T1.PLATE("", "reader")
                ...
                Case "TRISTAR":    PLATEREADER_VALUE = T1.TRISTAR_VALUE(wellpos, id)
...
Rem TriStar
Rem ::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
Private Function scan_column(rng As Range, str As String) As Range
    For Each cel In rng
        If 0 < InStr(cel.Value, str) Then
            Set scan_column = cel
            Exit Function
        End If
    Next
...
Public Function TRISTAR_INFO(param As String) As String
        On Error GoTo TRISTAR_INFO_ERR
        Application.Volatile
 
        With Sheets(T1.PLATE("", "rawdatasheet"))
                Select Case param
                        Case "date": TRISTAR_INFO = Format(scan_column(.Range("A:A"), "/").Value, "yyyy/mm/dd")
                        Case "time": TRISTAR_INFO = Format(scan_column(.Range("A:A"), "/").Offset(0, 1).Value, "hh:nn")
                        Case "assay":  asy = Replace(.Range("B9").Value, "Template file : ", "")
                                              TRISTAR_INFO = Mid(asy, 1, InStr(asy, "par") + 2)
                        Case "platetype":  TRISTAR_INFO = Replace(.Range("B13").Value, "Plate Type: ", "")
                End Select
        End With
...
TRISTAR_INFO_ERR:
        TRISTAR_INFO = CVErr(xlErrRef)
End Function
 
 
Public Function TRISTAR_VALUE(wellpos As String, id As String, Optional param1 As Variant = Null, Optional param2 As Variant = Null, Optional param3 As Variant = Null) As Variant
    Application.Volatile
    On Error GoTo TRISTAR_VALUE_ERR
    ...
    With Sheets(T1.PLATE("", "rawdatasheet"))
        TRISTAR_VALUE = scan_column(.Range("A:A"), "/").Offset(rw * 2 + 4, cl).Value
    End With
    Exit Function
 
TRISTAR_VALUE_ERR:
        TRISTAR_VALUE = CVErr(xlErrRef)
End Function
...
Attribute Macro1.VB_ProcData.VB_Invoke_Func = " \n14"
    ...
    MsgBox ActiveSheet.Range("14:14").Find(What:="G3").Value
End Sub
Sub Macro2()
